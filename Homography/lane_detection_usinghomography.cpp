...
int main() {
    ...
    VideoCapture capture("/Users/anirudhramesh/Desktop/CSCI731_finalprojectcode/drivingVideo.mp4");
    if (!capture.isOpened()) {
    ...
    for (int i =0; i <215; i++){  
        ...
        if (i %2 == 0 or i%2 != 0){
            ...
            int x = frame1.rows;
            int y = frame1.cols; 
            vertices.push_back(Point(0,550));                 // Bottom-left corner
            vertices.push_back(Point(150, 0));                // Top-left corner
            ...
            int min_line_len = 10; // minimum number of pixels making up a line
            ...
            if (addedP && addedN) {
                ...
                vector<Point2f> dash_cam_corners = {Point2f(20, 600), 
                                                 Point2f(200 , 375), 
                                                 Point2f(840 ,375), 
                                                 Point2f(1100, 600 )};
                // Perform homography 
